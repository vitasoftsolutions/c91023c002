...
import { fetchLoanTransaction, updateLoanTransactions } from "../../../redux/Actions/LoanTransactionsAction";
  ...
  const submitFunction = (data) => {
    if (state) {
      const updateData = {
        ...
        current_amount: data.current_amount ? data.current_amount : state.current_amount,
        ...
        interested_amount: data.interested_amount ? data.interested_amount : state.interested_amount,
        last_payed: data.last_payed ? data.last_payed : state.last_payed,
        return_amount: data.return_amount ? data.return_amount : state.return_amount,
