...
import { createLoanBen } from "../../../redux/Actions/ContractorBenAction";
...
const ContractorBenCreate = () => {
    const dispatch = useDispatch();
  const loanState = useSelector((state) => state.ContractorBenReducers);
  ...
  useEffect(() => {
    if (loanState.isCreated) {
      ...
      setTimeout(() => {
        navigate("/contractor-beneficaries");
      }, 3000);
    }
...
export default ContractorBenCreate;