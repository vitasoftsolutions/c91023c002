...
export const fetchLoanBeneList = createAsyncThunk(
  ...
  async (page, { getState }) => {
    ...
    const response = await axios.get(
      `${base_url}/contractor-payment/?limit=${perPage}&offset=${(page - 1) * perPage
      }`,
      {
        headers,
      }
...
export const fetchLoanBene = createAsyncThunk("fetchLoanBene", async (id) => {
  ...
  // Make the Axios GET request with the headers
  const response = await axios.get(`${base_url}/contractor-payment/${id}/`, {
    headers,
  });
...
export const deleteLoanBeneficiary = createAsyncThunk(
  ...
  async (payload) => {
    ...
    const response = await axios.delete(
      `${base_url}/contractor-payment/${payload}/`,
      { headers }
    );
...
export const updateLoanBeneficiary = createAsyncThunk(
  ...
  async (payload) => {
    ...
    const response = await axios.patch(
      `${base_url}/contractor-payment/${payload.id}/`,
      payload.data,
      { headers }
    );
...
export const searchLoanBeneficiaries = createAsyncThunk(
  ...
  async (firstName) => {
    try {
      ...
      let apiUrl = `${base_url}/contractor-payment/`;
