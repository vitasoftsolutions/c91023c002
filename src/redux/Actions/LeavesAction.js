...
//
//
// https://erpcons.vitasoftsolutions.com/leaves/
//
export const createLeaves = createAsyncThunk(
  "createLeaves",
  async (payload) => {
...
export const fetchLeavesList = createAsyncThunk(
  ...
  async (page, { getState }) => {
    ...
    const { perPage } = getState().leavesReducer;
...
//
//
export const fetchLeavesAllList = createAsyncThunk(
  "fetchLeavesAllList",
  async (payload) => {
...
//
//
export const fetchLeaves = createAsyncThunk("fetchLeaves", async (id) => {
...
//
//
export const updateLeaves = createAsyncThunk(
  "updateLeaves",
  async (payload) => {
    console.log(payload, "payload");
    // Get the JWT token from session storage
...
//
//
export const sortByDateLeaves = createAsyncThunk(
  "sortByDateLeaves",
  async (date) => {
    try {
      // Get the JWT token from session storage
...
//
//
export const sortByAZLeaves = createAsyncThunk(
  "sortByAZLeaves",
  async (sortOrder) => {
    try {
      // Get the JWT token from session storage
