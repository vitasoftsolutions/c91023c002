...
export const fetchLoanBeneList = createAsyncThunk(
    ...
    async (page, { getState }) => {
        ...
        const response = await axios.get(
            `${base_url}/property-installment/?limit=${perPage}&offset=${(page - 1) * perPage
            }`,
            {
                headers,
            }
...
export const fetchLoanBene = createAsyncThunk("fetchLoanBene", async (id) => {
    ...
    // Make the Axios GET request with the headers
    const response = await axios.get(`${base_url}/property-installment/${id}/`, {
        headers,
    });
...
export const projectlist = createAsyncThunk("projectlist", async () => {
    ...
    //contractor
    const response2 = await axios.get(`${base_url}/property/?limit=9999999999999999`, {
        headers,
    });
    ...
    //purchase
    const response3 = await axios.get(`${base_url}/property-purchase/`, {
        headers,
    });

    const response_token3 = response3.data.results.token;

    const result3 = jwtDecode(response_token3);
...
export const deleteLoanBeneficiary = createAsyncThunk(
    ...
    async (payload) => {
        ...
        const response = await axios.delete(
            `${base_url}/property-installment/${payload}/`,
            { headers }
        );
...
export const updateLoanBeneficiary = createAsyncThunk(
    ...
    async (payload) => {
        ...
        const response = await axios.patch(
            `${base_url}/property-installment/${payload.id}/`,
            payload.data,
            { headers }
        );
...
export const searchLoanBeneficiaries = createAsyncThunk(
    ...
    async (firstName) => {
        try {
            ...
            let apiUrl = `${base_url}/property-installment/`;
