...
export const fetchLoanBeneList = createAsyncThunk(
  ...
  async (page, { getState }) => {
    ...
    const { perPage } = getState().applabelReducer;
    ...
    const response = await axios.get(
      `${base_url}/work-progress/?limit=${perPage}&offset=${
        (page - 1) * perPage
      }`,
      {
        headers,
...
//
//
export const fetchWorkProgressAllList = createAsyncThunk(
  ...
  async (payload) => {
    ...
    // Make the Axios GET request with the headers
    const response = await axios.get(
      `${base_url}/work-progress/`,{headers});
...
export const fetchLoanBene = createAsyncThunk("fetchLoanBene", async (id) => {
  ...
  // Make the Axios GET request with the headers
  const response = await axios.get(`${base_url}/work-progress/${id}/`, {
    headers,
  });
...
export const deleteLoanBeneficiary = createAsyncThunk(
  ...
  async (payload) => {
    ...
    const response = await axios.delete(
      `${base_url}/work-progress/${payload}/`,
      { headers }
    );
...
export const updateLoanBeneficiary = createAsyncThunk(
  ...
  async (payload) => {
    ...
    const response = await axios.patch(
      `${base_url}/work-progress/${payload.id}/`,
      payload.data,
      { headers }
    );
...
export const searchLoanBeneficiaries = createAsyncThunk(
  ...
  async (firstName) => {
    try {
      ...
      let apiUrl = `${base_url}/work-progress/`;
